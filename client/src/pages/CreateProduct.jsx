...
import { ADD_PRODUCT_FAILED, ADD_PRODUCT_REQUEST, ADD_PRODUCT_SUCCESS } from '../features/productSlice'
...
const dispatch=useDispatch()
  ...
  const handleProductSubmit=async(e)=>{
    ...
    dispatch(ADD_PRODUCT_REQUEST())
      ...
      dispatch(ADD_PRODUCT_FAILED(data.message))
      }else{
        dispatch(ADD_PRODUCT_SUCCESS(data.newProduct))
        navigate(`/product/${data.newProduct._id}`)
      }

    } catch (error) {
      dispatch(ADD_PRODUCT_FAILED(error.message))
    }
  }
